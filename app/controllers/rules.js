const rules = {
  ...
  '/user/change/phone': [
    {name: 'newphone', require: true, min: 11, max: 11, desc: '新手机号'},
    {name: 'code', require: true, min: 6, max: 6, desc: '验证码'}],
  '/user/modify/pass': [
    {name: 'newpass', require: true, min: 6, max: 20, desc: '原密码'},
  ...
  '/user/check/phone': [
    {name: 'phone', require: true, min: 0, max: 20, desc: '手机号'},
    {name: 'code', require: true, min: 0, max: 20, desc: '验证码'}],
  '/user/update/avatar': [
